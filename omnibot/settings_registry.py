...
SETTINGS: list[dict[str, Any]] = [
    ...
    {"id": "music.defaultVolume", "path": "music.defaultVolume", "type": "number", "default": 50, "category": "music"},
    # Logging
    {"id": "logging.enabled", "path": "logging.enabled", "type": "bool", "default": False, "category": "logging"},
    ...
    {"id": "tickets.staffRoleId", "path": "tickets.staffRoleId", "type": "role", "default": "", "category": "tickets"},
    # Fun
    {"id": "economy.enabled", "path": "economySettings.enabled", "type": "bool", "default": True, "category": "fun"},
    # Voice
    ...
    # Advanced security
    {"id": "security.antiNukeEnabled", "path": "security.antiNuke.enabled", "type": "bool", "default": True, "category": "moderation"},
    {"id": "security.windowSec", "path": "security.antiNuke.windowSec", "type": "number", "default": 30, "category": "moderation"},
    # Booster roles / autoname / bump / social
    {"id": "boosterRoles.enabled", "path": "boosterRoles.enabled", "type": "bool", "default": False, "category": "engagement"},
    {"id": "boosterRoles.roleId", "path": "boosterRoles.roleId", "type": "role", "default": "", "category": "engagement"},
    {"id": "autoName.enabled", "path": "autoName.enabled", "type": "bool", "default": False, "category": "engagement"},
    {"id": "autoName.template", "path": "autoName.template", "type": "text", "default": "", "category": "engagement"},
    {"id": "bump.enabled", "path": "bumpReminder.enabled", "type": "bool", "default": False, "category": "engagement"},
    {"id": "bump.channelId", "path": "bumpReminder.channelId", "type": "channel", "default": "", "category": "engagement"},
    {"id": "bump.message", "path": "bumpReminder.message", "type": "text", "default": "⏰ Time to /bump the server!", "category": "engagement"},
    {"id": "social.enabled", "path": "social.enabled", "type": "bool", "default": False, "category": "engagement"},
    {"id": "social.channelId", "path": "social.channelId", "type": "channel", "default": "", "category": "engagement"},
    {"id": "suggestions.channelId", "path": "suggestions.channelId", "type": "channel", "default": "", "category": "engagement"},
    {"id": "birthday.channelId", "path": "birthdaySettings.channelId", "type": "channel", "default": "", "category": "engagement"},
    {"id": "birthday.enabled", "path": "birthdaySettings.enabled", "type": "bool", "default": False, "category": "engagement"},
]
...
def get_defaults_nested() -> dict[str, Any]:
    ...
    root.setdefault("boosterRoles", {"enabled": False, "roleId": ""})
    root.setdefault("autoName", {"enabled": False, "template": ""})
    root.setdefault("bumpReminder", {"enabled": False, "channelId": "", "message": "⏰ Time to /bump the server!"})
    root.setdefault("social", {"enabled": False, "channelId": "", "feeds": []})
    root.setdefault("analytics", {"messages": 0, "joins": 0, "leaves": 0, "commands": 0})
    root.setdefault("quotes", [])
    root.setdefault("serverDocs", {})
    root.setdefault("forms", {})
    return root
